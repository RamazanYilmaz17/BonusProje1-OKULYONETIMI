...
WHERE        (TBLOGRENCILER.OGRAD = @OGRAD)";
            ...
            this._commandCollection[2].CommandText = "INSERT INTO TBLOGRENCILER\r\n                         (OGRAD, OGRSOYAD, OGRKULUP, O" +
                "GRCINSIYET)\r\nVALUES        (@OGRAD,@OGRESOYAD,@OGRKULUP,@OGRCINSIYET)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OGRESOYAD", global::System.Data.SqlDbType.VarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "OGRSOYAD", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int OgrenciEkle(string OGRAD, string OGRESOYAD, global::System.Nullable<byte> OGRKULUP, string OGRCINSIYET) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((OGRAD == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            if ((OGRESOYAD == null)) {
                ...
                command.Parameters[1].Value = ((string)(OGRESOYAD));
            }
    ...
    public partial class TBLNOTLARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        TBLDERSLER.DERSAD, TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRSOYAD, TBLNOTLAR.NOTID, TBLNOTLAR.OGRID, TBLNOTLAR.SINAV1, TBLNOTLAR.SINAV2, TBLNOTLAR.SINAV3, TBLNOTLAR.PROJE, 
